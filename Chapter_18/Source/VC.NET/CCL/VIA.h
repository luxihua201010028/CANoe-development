...
09.12.2010   1.41  As     Acess to 'User Files' added. A DLL can now reject the 
                          creation of a nodelayer object.
08.03.2011   1.42  As     Systemvariables: Default Module Handle and type Data added
...
18.01.2011   1.45  Rue    Systemvariables: define with initial value
...
20.02.2012   1.50  Rue    Extensions for system variable structs
...
13.08.2014   1.63  Cbo    EVAL00123427: VIA Erweiterung zur Übertagung der Multiplex Informationen für Frame/PDU
...
public:
  ...
  // for arrays, returns the length of a single array element
